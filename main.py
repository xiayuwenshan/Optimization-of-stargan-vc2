...
if __name__ == '__main__':
    ...
    #parser.add_argument('--lambda_cyc', type=float, default=10, help='Weight of cycle loss.')#原模型是10
    ...
    parser.add_argument('--num_iters', type=int, default=20000, help='Number of total iterations for training discriminator.')
    parser.add_argument('--num_iters_decay', type=int, default=100000, help='Number of iterations for decaying learning rate.')
    parser.add_argument('--g_lr', type=float, default=0.0004, help='Learning rate of generator.')
    ...
    parser.add_argument('--beta1', type=float, default=0.9, help='Beta1 for Adam optimizer.')             # 原来0.5
    parser.add_argument('--beta2', type=float, default=0.999, help='Beta2 for Adam optimizer.')
    parser.add_argument('--resume_iters', type=int, default=None, help='The start step of training.')
    
    # Test configuration.
    parser.add_argument('--test_iters', type=int, default=8000, help='The start step of testing.')
    #parser.add_argument('--src_speaker', type=str, default="TM1", help='Source speaker for testing.')
    parser.add_argument('--src_speaker', type=str, default="TM2", help='Source speaker for testing.')
    #parser.add_argument('--trg_speaker', type=str, default="['TM1', 'SF1']", help='String list representation of target speakers eg. "[a,b]".')
    parser.add_argument('--trg_speaker', type=str, default="['TM1']", help='String list representation of target speakers eg. "[a,b]".')

    parser.add_argument('--num_workers', type=int, default=0)
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'convert', 'eval'])
    ...
    #parser.add_argument('--result_dir', type=str, default='outputs/results/改进模型的测试结果')
    #parser.add_argument('--result_dir', type=str, default='outputs/results/原始模型的测试结果/最新')
    #parser.add_argument('--result_dir', type=str, default='outputs/results/改进模型plus的测试结果')
    parser.add_argument('--result_dir', type=str, default='outputs/results/测试超参数/-0.03')
    #parser.add_argument('--result_dir', type=str, default='outputs/results/原始模型')
    #parser.add_argument('--result_dir', type=str, default='outputs/results/微型子网络/-0.75')
    parser.add_argument('--start_testmodel_num', type=int, default=0)
